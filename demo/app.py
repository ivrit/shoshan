...
with gr.Blocks(title="Shoshan vs DictaBERT-lex") as demo:
    ...
    gr.Examples(
        examples=[
            ...
            ["הג'דיי הניף את הלייטסייבר הזוהר שלו על הבמה."],
    ...
    gr.Markdown(
        ...
        "2. *ha-jedai henif et ha-laytseiber ha-zoher…* — 'The Jedi waved his glowing lightsaber "
        "on stage.' Watch the loanword **הלייטסייבר** *ha-laytseiber*.\n"
