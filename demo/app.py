...
HEAD2HEAD = [
    ...
    ("הלייטסייבר", "the lightsaber", "הג'דיי הניף את הלייטסייבר הזוהר שלו על הבמה.", "[BLANK]", "", True),
    ("בסייברפאנק", "in cyberpunk", "העלילה מתרחשת בעולם סייברפאנק עתידני.", "[BLANK]", "", True),
    ("המחברות", "the notebooks", "המורה חילקה את המחברות לתלמידים בכיתה.", "מחברת", "notebook", False),
]
        ...
        with gr.Tab("Lemmatize"):
            ...
            gr.Examples(
                examples=[
                    ...
                    ["המורה חילקה את המחברות לתלמידים בכיתה והניחה את השאר בארון."],
                ],
